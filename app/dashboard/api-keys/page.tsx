...
export default function ApiKeysPage() {
  ...
  const availableScopes = useMemo(() => ['read:collections'], [])
  const [selectedScopes, setSelectedScopes] = useState<string[]>(['read:collections'])
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDescription('')
      setExpiresAt('')
      setSelectedScopes(['read:collections'])
    } catch (e: any) {
